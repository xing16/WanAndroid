...
public class SearchHistoryAdapter extends BaseQuickAdapter<SearchResult.DatasBean, BaseViewHolder> {

    public SearchHistoryAdapter(int layoutResId, @Nullable List<SearchResult.DatasBean> data) {
